...
import { toggleComplete, toggleImportant } from "../store/tasksSlice";
      ...
      >
        <View style={styles.headerRow}>
          ...
          <View style={styles.iconGroup}>
            <TouchableOpacity
              onPress={() => dispatch(toggleImportant(item.id))}
            >
              <Ionicons
                name={item.important ? "heart" : "heart-outline"}
                size={18}
                color={
                  item.important ? "#ef4444" : isDark ? "#9ca3af" : "#6b7280"
                }
                style={styles.icon}
              />
            </TouchableOpacity>
        ...
        {isExpanded && (
          <>
            ...
            {extractValidUrls(item.urls).map((urlItem, idx) => {
              const sanitizedUrl =
                urlItem.startsWith("http://") || urlItem.startsWith("https://")
                  ? urlItem
                  : `https://${urlItem}`;
            ...
            <View style={styles.footerRow}>
              ...
              >
                <Text style={styles.statusText}>
                  {item.completed ? "Mark as Completed" : "Mark as Incomplete"}
                </Text>
              </TouchableOpacity>
            </View>
          </>
